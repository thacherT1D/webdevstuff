...
### !challenge
* type: project
* id: computer-science-drills-binary-converter
* title: Binary Converter

##### !question
### Write a converter

Test yourself by writing a [binary-to-decimal converter](https://github.com/gSchool/computer-science-drills/blob/master/src/binary-encoding/binary.js).
