<div style="display: block;background:white;border:none;width:100%;padding:30px;">
  <img src="http://knexjs.org/docs/images/knex.png" style="display:block;margin:0 auto; width:50%;"/>
</div>

[Knex](http://knexjs.org/) is a batteries included query builder. Whereas before we've been writing SQL queries by hand (how craftsy of us), many developers enjoy using some type of query builder so that they can write less direct SQL and more JavaScript.

* [Objectives](#objectives)
* [What is Knex.js?](#what-is-knexjs)
* [Why is Knex.js useful?](#why-is-knexjs-useful)
* [Selecting Data with Knex](#selecting-data-with-knex)
* [Inserting Data with Knex](#inserting-data-with-knex)
* [Updating Data with Knex](#updating-data-with-knex)
* [Deleting Data with Knex](#deleting-data-with-knex)
* [Assignment](#assignment)
* [Resources](#resources)
* [Videos](#videos)

Our goal in this lesson will be to install, use, and describe the Knex library including how it differs in contrast to a simpler library that requires you to write direct SQL like [pg-promise](https://github.com/vitaly-t/pg-promise). We will also discuss migrations in detail and discuss why we use them.
