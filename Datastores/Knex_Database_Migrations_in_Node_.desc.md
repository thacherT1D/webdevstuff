...
Included in the exercise [repo](https://github.com/gSchool/knex-migrations-and-deployment) is a Library CRUD app. Your mission is to add `Books` and `Readers` schemas to this app using `knex` migrations.
