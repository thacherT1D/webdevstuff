...
The goal of this group project is to demonstrate your mastery of the concepts covered over the past quarter. Like your capstone, you and your partner are expected to come up with a project idea and implement it all on your own. Unlike a PhD dissertation, you are _not_ expected to discover and publish an idea that's never been done before. Asking your classmates and instructors for help throughout the process is strongly encouraged, but your group's work must be your own.

During project week, your group will have approximately 24 hours of class time to implement your idea. It'll most likely not be enough time, so plan on allocating extra time for it outside of class. On the last day of project week, your group will give a short demonstration of your project to the class.
...
- Send HTTP requests to a RESTful HTTP server application of your creation.

The server-specific technical requirements for your project:

- Send HTTP responses back to a RESTful HTTP client application of your creation.
- Store and retrieve at least two one-to-many relationships using a relational database.
- Register, authenticate, and authorize a user securely.
- Be deployed to a production environment.

### Bonuses

- Connect to at least one external web API via [server-side HTTP requests](https://www.npmjs.com/package/superagent).
...
Please complete the following [template wireframe](https://students-gschool-production.s3.amazonaws.com/uploads/asset/file/507/Wireframe_Template.pdf). The wireframe template can be printed out on 11×17 inch paper. Here's an example of a past student's wireframe.

![](https://students-gschool-production.s3.amazonaws.com/uploads/asset/file/188/brewify.jpg)

In addition, include an entity-relationship diagram of the tables and columns of your project's database.
...
After your proposal has been approved, you and your partner will assume the roles of the co-leaders and will need to work as such. A leader does not have subordinates who do as they're told. Instead, a leader has followers and following is always a voluntary activity.

Telling your partner what to will not inspire them to follow you. To do that, you'll have to focus on your partner's needs before you consider your own. This is called [servant leadership](https://www.mindtools.com/pages/article/servant-leadership.htm) and is a well-researched and documented leadership style. Putting other people's needs before your own has the following advantages.

1. Your partner will trust what you have to say.
1. Your partner will be more likely to put your needs before their own.
1. Teaching other people gives you a deeper understanding of complex concepts.
1. Helping other people feels good.
