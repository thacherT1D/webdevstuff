...
**TIP:** The full name of your working directory is `~/workspace/wcrusher.surge.sh`. To save prompt space, Fish abbreviates it. This is especially handy for **deeply nested** directories.
...
> You may need to Accept xcode license with `sudo xcodebuild -license`
