...
With the React Developers Tools, you can finally see that a **component** is an instance of either a React component class or HTML tag. And, a component hierarchy is made up of a root component with possible children, grandchildren, etc. You can confirm this by rendering a second component hierarchy for the **Hello world** application using the same root component class. Start by adding another application container to the `app/assets/index.html` file.
