...
Using the links above, install the React Developer Tools for both browsers. The Chrome extension needs a little configuration though. Once it's installed, config Chrome's React Developer Tools with the following steps.
