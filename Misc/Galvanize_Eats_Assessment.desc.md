...
**Galvanize Eats** is a food service that delivers burgers and pizza on demand. You are building their new site, which includes a ordering web app. The landing page of the site should tell you some basic information about the company, while the web app should show you a sorted list of menu items, allow you to build an order, enter in your delivery information, and submit the order to Galvanize Eats. Your product owner has created a list of prioritized user stories for you to work down in the readme file of the github repository.

## Use the Galvanize Eats repo as a base

Fork/clone [this repo](https://github.com/gSchool/G29-Q1-Assessment). You are required to use this repo and keep this folder structure.
...
* Commit your work to github often
* Deploy your work
