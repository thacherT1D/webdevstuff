...
One way to do that, is to write down anything that's on your mind, anything that you need to do later. Put it in safe, reliable todo list somewhere. Picking up flowers, taking out the trash, whatever else you're thinking about. Toss it all in a journal or in a todo list. That way, your non-learning tasks won't bother you while you're trying to learn.
...
![](https://students-gschool-production.s3.amazonaws.com/uploads/asset/file/299/proxSmaller.png)
