...
- 1 of 15:  describe the characteristics of a  programming language
- 2 of 15:  articulate four reasons for learning JavaScript
- 3 of 15:  identify and describe the primitive data types in JavaScript
- 4 of 15:  use a REPL (read, evaluate, print, loop) to complete the following tasks:
